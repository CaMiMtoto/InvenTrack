...
@section('content')
    ...
    <div class="modal fade" tabindex="-1" id="myModal">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.merchants.store') }}" id="submitForm" method="post">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" id="adjustUtilityBalanceModal">
        <div class="modal-dialog  modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title">
                ...
                <div id="adjustUtilityBalanceForm"></div>
        ...
        $(function () {
            let myTable = $('#myTable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'utility_balance', name: 'utility_balance', orderable: false, searchable: false},
                    {data: 'payment_balance', name: 'payment_balance', orderable: false, searchable: false},
                    {
                        data: 'status',
                        name: 'status',
                        render: function (data, type, row) {
                            return `<span class="badge bg-${row.status_color}-subtle rounded-pill text-uppercase text-${row.status_color}-emphasis">${data}</span>`
                        }
                    },
                    {
                        data: 'action',
