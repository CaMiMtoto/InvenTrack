    ...
    <div class="row g-5 mb-5">
            ...
            <div class="card card-flush mb-5 mb-xl-10 bg-success-subtle text-success-emphasis">
                ...
                <div class="card-body">
                    <div class="card-title d-flex flex-column">
                        <span title="{{ number_format($stockSold) }}"
                              class="fs-2hx fw-bold  text-success-emphasis me-2 lh-1 ls-n2">{{ formatNumberToShort($stockSold, 2) }}</span>
                        <span class="text-dark-emphasis pt-1 fw-semibold fs-6">Stock Sold</span>
                    </div>
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <div class="card card-flush  mb-5 mb-xl-10   bg-primary-subtle text-primary-emphasis">
                <div class="card-body">
                    <div class="card-title d-flex flex-column">
                        <span class="fs-2hx fw-bold text-primary me-2 lh-1 ls-n2">{{ $allReturns }}</span>
                        <span class="text-primary-emphasis pt-1 fw-semibold fs-6">All Returns</span>
                    </div>
