<div>
    ...
    <div>
        ...
        <div>
            {{--            Totals--}}
            <div class="d-flex flex-column flex-md-row justify-content-end align-items-center mt-5 px-4 gap-2">
                <div class="d-flex align-items-center">
                    <span class="fw-bold">Total Sales:</span>
                    <span class="text-gray-700 ms-2">{{ number_format($totalSales) }}</span>
                </div>
                <div class="d-flex align-items-center">
                    <span class="fw-bold">Total Expenses:</span>
                    <span class="text-gray-700 ms-2">{{ number_format($totalExpenses) }}</span>
                </div>
                <div class="d-flex align-items-center">
