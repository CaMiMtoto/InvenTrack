        ...
        <div class="d-flex flex-column flex-lg-row justify-content-between gap-3 align-items-lg-center mb-4">
            <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-3">
                ...
                <div class="d-flex flex-column flex-sm-row align-items-sm-center gap-3">
                    ...
                    <select class="form-select form-select-sm" wire:model.live="serviceId">
        ...
        <div class="table-responsive position-relative">
            ...
            <table
                ...
                <tr class="text-start text-gray-800 fw-bold fs-7 text-uppercase">
                    ...
                    <x-table.sortable label="Account" column="account_reference" :sortCol="$sortCol" :dir="$dir"
                                      wireClick="handleSort('account_reference')"/>
                    <x-table.sortable label="Customer" column="customer_name" :sortCol="$sortCol" :dir="$dir"
                                      wireClick="handleSort('customer_name')"/>
                ...
                @forelse($transactions as $item)
                    <tr>
                        ...
                        {{-- <td>
                             --}}{{--<code>
                                 {{json_encode($item->provider_response)}}
                             </code>--}}{{--
                                 <a href=""
                                    class="btn btn-sm btn-light-primary">
                                     <x-lucide-eye class="me-1 tw-h-5 tw-w-5"/>
                                     View
                                 </a>
