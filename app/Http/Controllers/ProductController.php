...
use App\Models\Product;
 // ProductClass removed from immediate product listing; keep model available elsewhere
...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate([
            ...
            // product class removed from product form; keep optional if present
            'product_class_id'=>'nullable|integer|exists:product_classes,id',
        ]);
        if (empty($data['sku'])) {
